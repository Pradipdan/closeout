...
class RoleController extends Controller
{
    ...
    public function getAll()
    {
        ...
        ->addColumn('actions', function ($row) {
            ...
            $updateButton = "<a data-bs-toggle='tooltip' title='Edit' data-bs-delay='400' class='btn-sm border-warning'  href='" . route('app-roles-edit', $encryptedId) . "'><i class='text-warning' data-feather='edit'></i></a>";
            ...
            $deleteButton = "<a data-bs-toggle='tooltip' title='Delete' data-bs-delay='400' class=' btn-sm border-danger confirm-delete' data-idos='$encryptedId' id='confirm-color  href='" . route('app-roles-delete', $encryptedId) . "'><i class='text-danger' data-feather='trash-2'></i></a>";
