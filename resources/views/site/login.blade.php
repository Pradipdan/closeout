                ...
                <div class="auth-inner my-2">
                    ...
                    <div class="card mb-0 login_card">
                        <div class="card-body">
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Artboard" transform="translate(-400.000000, -178.000000)">
                                        <g id="Group" transform="translate(400.000000, 178.000000)">
                                            ...
                                            <polygon id="Path-2" fill="#1d1d1d" opacity="0.049999997"
                                                points="69.3922914 32.4202615 32.8435758 70.5039241 54.0490008 16.1851325">
                                            </polygon>
                                            <polygon id="Path-21" fill="#1d1d1d" opacity="0.099999994"
                            ...
                            <p class="card-text mb-2">Please Log-in to your account to start.</p> --}}
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-1 mt-3">
                                    ...
                                    <div class="input-group input-group-merge form-password-toggle">
                                        ...
                                        <span class="input-group-text cursor-pointer site_login_view_password"><i
                                ...
                                @error('email')
                                    <span class="invalid-feedback d-inline-block mb-1" role="alert">
                                        <strong>Please check your credentials again.</strong>
                                    </span>
                                @enderror
                                <div class="my-3">

                                    <button class="btn login_btn w-100" tabindex="4">Log in</button>
                                </div>
                        </div>
                        <p class="text-center ">
                            <span>Don't have an account?</span>
                            <a href="{{route('site.sign-in')}}">
                                Sign Up
                            </a>
                        </p>
                        </form>
